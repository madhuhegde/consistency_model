...
def parse_args():
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/content/gdrive/MyDrive/consistency/diffusers/models",
    ...
    parser.add_argument(
        ...
        type=str,
        default="pipe:curl -L -s https://huggingface.co/datasets/laion/conceptual-captions-12m-webdataset/resolve/main/data/{00000..01099}.tar?download=true",
        help=(
